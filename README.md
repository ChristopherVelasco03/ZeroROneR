...
- Implementar matrices de confusión
- Agregar visualizaciones (gráficos de precisión)
- Soporte para datos continuos en One-R (discretización)
- Exportar reglas a formato JSON/XML
- Agregar más métricas (F1-score, precisión, recall)
